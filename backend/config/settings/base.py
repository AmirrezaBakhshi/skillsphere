...
live in dev.py / prod.py so we never branch on DEBUG inside application code.
"""
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://skillsphere:skillsphere@db:5432/skillsphere")
}
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "apps.users.infrastructure.django.authentication.CookieJWTAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": ("rest_framework.permissions.IsAuthenticated",),
    "DEFAULT_RENDERER_CLASSES": ("rest_framework.renderers.JSONRenderer",),
    "EXCEPTION_HANDLER": "apps.users.api.exception_handler.domain_exception_handler",
}
...
JWT_REFRESH_COOKIE_NAME = "ss_refresh_token"
JWT_REFRESH_COOKIE_PATH = "/api/v1/auth/"
JWT_ACCESS_COOKIE_NAME = "ss_access_token"
...
# Only read/used when EMAIL_BACKEND is Django's SMTP backend (production) -
# the console backend (dev's default) ignores all of these.
